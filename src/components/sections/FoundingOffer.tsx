            ...
            <Reveal duration={0.7} delay={0.3}>
              <div className="mt-6 pt-2">
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="bg-[#FE4C02] text-[#0A0A0A] font-bold text-[13px] md:text-[14px] tracking-[0.08em] uppercase px-9 py-4 min-h-[52px] hover:bg-white hover:text-[#0A0A0A] transition-all duration-200"
                >
                  BUY NOW
                </Button>
              </div>
